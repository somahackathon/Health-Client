import { TestItem, TestItemCode } from '../../../shared/api/types';
import { gradeColor } from '../../../shared/theme/colors';
import { GRADE_TEXT, TEST_ITEM_NAME } from '../../../entities/paps-record/lib/paps';
import { usePapsStore } from './usePapsStore';
