...
import { requestFitnessAnalysis } from '../api/fitnessAnalysis';
import { AnalysisStatus, Recommendation } from '../../../shared/api/types';
...
import * as papsRecordsDb from '../../../entities/paps-record/model/papsRecords';
